INSERT INTO tbl_facturas(fac_id, fac_descripcion, fac_idcliente, fac_estado) VALUES ( 2 , ' factura menu del dia ' , 1 , ' CREADO ' );
INSERT INTO tbl_facturas(fac_id, fac_descripcion, fac_idcliente, fac_estado) VALUES ( 3 , ' factura menu del dia ' , 2 , ' CREADO ' );
